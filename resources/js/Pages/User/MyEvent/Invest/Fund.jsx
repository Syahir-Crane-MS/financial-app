...
export default function Fund({ transactions, session_id }) {
    const title = "Index Fund";
                        ...
                        <tr>
                            ...
                            <td>
                                <b>
                                    ...
                                    }).format(item.fund.current_fund_price)}
                                </b>
                            </td>
                        </tr>
                    </table>
        ...
        <AuthenticatedLayout header={title} breadcrumbs={null}>
            ...
            >
                ...
                <Typography sx={{ color: "white" }}>
                    List of all index fund transaction
                </Typography>
            </Box>

            <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                {data.length ? (
                    data.map((data) => cardFund(data))
                ) : (
