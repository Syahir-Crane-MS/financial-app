...
export default function Index({ incomes }) {
    ...
    const { income_type, level } = useUserStore();
    ...
    const typeLabel = (data) => {
        const found = income_type.find((item) => item.value === data);

        return found ? found.label : "Unknown";
    };

    const levelLabel = (data) => {
        const found = level.find((item) => item.value === data);

        return found ? found.label : "Unknown";
    };

    const rows = income?.map((data) => ({
        uuid: data.uuid,
        id: data.id,
        title: data.title,
        income_type: data.income_type,
        income_type_label: typeLabel(data.income_type),
