...
export default function Index({ stocks }) {
    ...
    const rows = stock?.map((data) => ({
        uuid: data.uuid,
        id: data.id,
        title: data.title,
        current_stock_price: data.current_stock_price,
        stock_price_format: new Intl.NumberFormat("en-US", {
            minimumFractionDigits: 2,
            maximumFractionDigits: 2,
        }).format(data.current_stock_price),
        dividen_per_share: data.dividen_per_share,
        dividen_format: new Intl.NumberFormat("en-US", {
            minimumFractionDigits: 2,
            maximumFractionDigits: 2,
        }).format(data.dividen_per_share),
    }));
    ...
    const columns = [
        ...
        {
            field: "stock_price_format",
            headerName: "Current Stock Price",
            width: 200,
        },
        {
            field: "dividen_format",
            headerName: "Dividen Per Share",
            width: 200,
        },
        {
            field: "action",
            ...
            renderCell: (params) => (
                ...
                >
                    ...
                    <IconButton
                        component={"a"}
                        href={route("dividen.view", [params.row.id])}
                        sx={{
                            bgcolor: "#5e5e5e",
                            borderRadius: "5px",
                            height: "30px",
    ...
    const handleEdit = (row) => {
        ...
        setData({
            ...
            dividen_per_share: row.dividen_per_share || "",
        });
